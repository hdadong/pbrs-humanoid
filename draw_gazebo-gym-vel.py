...
def draw_picture(
    ...
    pylab.plot(input1, target1, 'r-', label='gazebo-vel')
    pylab.plot(input2, target2, 'g-', label='gym-vel')
    ...
    if name == 'reward':
        ...
        pylab.yticks(np.arange(-50.0, 50.0, 10.0))
...
gazebo_position = np.load('/home/bigeast/pbrs-humanoid/gazebo_velocity.npy')
gym_position = np.load('/home/bigeast/pbrs-humanoid/gym_velocity.npy')
